...
from models import db, User, UserRole, Permission, Employee, Supplier, Product, PurchaseOrder, PurchaseItem, Customer, SaleOrder, SaleItem, Collection, CashTransaction, FreezeDeposit, CashBox, JournalEntry, JournalDetail, DailyCashSummary
...
def inventory():
    ...
    return render_template('inventory/index.html', products=products, low_stock_count=low_stock_count)
...
def reports_data():
    ...
    total_collections_sum = sum(t.amount for t in cash_transactions if t.type == 'income')
    ...
    return jsonify({
        ...
        'total_collections': total_collections_sum,
        'sales': sales_data,
